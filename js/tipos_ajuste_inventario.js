            ...
            fila.innerHTML = `
                ...
                <td class="acciones text-right">
                    <div class="flex items-center justify-end gap-2">
                        <button class="btn-editar p-2 rounded-lg text-blue-500 hover:bg-blue-500/10 hover:text-blue-600 transition-colors" title="Editar" data-id="${t.id_tipos_ajuste}">
                            <span class="material-symbols-outlined text-xl pointer-events-none">edit</span>
                        </button>
                        <button class="btn-eliminar p-2 rounded-lg text-red-500 hover:bg-red-500/10 hover:text-red-600 transition-colors" title="Eliminar" data-id="${t.id_tipos_ajuste}">
